...
outfile = out_path + 'notails_' + pcafile + '_out.txt'
betafile = out_path + 'notails_' + pcafile + '_betas.txt'
...
embedded, betas = da_notails_sne.run_bh_tsne(transformed, initial_dims=transformed.shape[1], theta=0.3,
                                     verbose=True, perplexity=50, max_iter=500, use_pca=False)
