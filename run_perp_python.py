...
for i, p in enumerate(perps): 
    embedded, betas, orig_densities, emb_densities = bhtsne.run_bh_tsne(pc_data, 
                                                                        initial_dims=pc_data.shape[1], theta=0.3,verbose=True, perplexity=p, max_iter=1000, 
                                                                        use_pca=False)
